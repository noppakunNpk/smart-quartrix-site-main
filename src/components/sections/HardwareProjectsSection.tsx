    ...
    >
      ...
      <div className="h-48 overflow-hidden bg-gray-100 flex items-center justify-center relative">
        {project.image ? (
          ...
          /* Placeholder เดิมถ้าไม่มีรูป */
          <div className="w-full h-full bg-gradient-to-br from-[#1a2a3a] via-[#2a3a4a] to-[#0A1628] flex items-center justify-center">
      ...
      {/* ส่วนเนื้อหา */}
      <div className="p-6">
        <h3 className="font-heading text-lg font-600 text-sq-text mb-2 line-clamp-1">
          {project.title}
        </h3>
        {project.description && (
          <p className="text-sq-text-muted text-sm leading-relaxed line-clamp-2">
            {project.description}
          </p>
        )}
      </div>
